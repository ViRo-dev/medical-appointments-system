...
![BPMN диаграмма AS-IS](Medical_Diagrams/BPMN(AS-IS).png)
...
![BPMN диаграмма TO-BE](Medical_Diagrams/BPMN(TO-BE).png)

3)Составлена AS-IS диаграмма состояний в нотации UML State Machine
![AS-IS диаграмма UML State Machine](Medical_Diagrams/UML State Machine .png)

4)В рамках Agile-меодологии оставлена User Story Map и выделен MVP
![Гипотеза и персона для User Story Map](Прототип фуекции Чекапа/User Story Map(условия).png)
![User Story Map](Прототип фуекции Чекапа/User Story Map_Чекап.png)
...
![Storyboard)](Прототип фуекции Чекапа/1.png)
![Storyboard)](Прототип фуекции Чекапа/2.png)
...
![Гипотеза и персоны для User Story Map](Прототип функции  Обследование/Условие.png)
![User Story Map](Прототип функции  Обследование/User Story Map_Анализы1.png)
![User Story Map](Прототип функции  Обследование/User Story Map_Анализы2.png)
...
![DFD-контекстная](Medical_Diagrams/DFD_контекстная.png)
![DFD-логическая](Medical_Diagrams/DFD_логическая.png)
...
![Storyboard)](Прототип функции  Обследование/2.1.png)
![Storyboard)](Прототип функции  Обследование/2.2.png)
![Storyboard)](Прототип функции  Обследование/2.3.png)
